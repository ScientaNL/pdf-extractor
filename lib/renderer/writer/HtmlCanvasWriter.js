...
class HtmlCanvasWriter extends FileWriter
{
	...
	async writeCanvasPage(page, viewport, canvas) {
		const html = await this.renderHtmlLayer(page, viewport);
		return this.writeStringToFile(html, this.getFilePathForPage(page));
	}
...
module.exports = HtmlCanvasWriter;
