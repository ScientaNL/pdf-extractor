...
const { JSDOM } = jsdom;
const { Canvas, Context2d, Image, ImageData } = require("canvas");
...
// exports.HTMLElement = jsDom.window.HTMLElement;
exports.Image = Image;
...
exports.setGlobalDom = function(jsDomInstance) {
	...
	Object.defineProperty(jsDom.window._core.CSSStyleDeclaration.prototype, 'transformOrigin', {
		get : function () {
			return this.getPropertyValue('transform-origin');
		},
		set : function (v) {
			this._setProperty('transform-origin', v);
		},
		enumerable: true,
		configurable: true
	});
